package com.api_pagamento.redis_json.controller;
...
import com.api_pagamento.redis_json.service.TransacaoService;
...
public class TransacaoController {
    ...
    public ResponseEntity<TransacaoDTO> getById(@PathVariable Long id) throws TransacaoInexistenteException {

       return ResponseEntity.ok().body(transacaoService.getById(id));
    ...
    public ResponseEntity<List<TransacaoDTO>> getAll() throws TransacaoInexistenteException {

        return ResponseEntity.ok().body(transacaoService.getAll());
